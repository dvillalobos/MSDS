...
Is the confidence interval level for the normal model with standard error SE. The confidence interval for the population parameter is $point \: estimate ± z \cdot SE$ where $z$ corresponds to the confidence level selected.
